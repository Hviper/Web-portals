    ...
    <div class = "footer_content">
      <div class = "footer_logo footer-content-column">
        <div class = "logo-container">
          ...
          <div class="logo-text">
            <p class="text1">井冈山大学</p>
            <p class="text2">电子与信息工程学院</p>
          </div>
        </div>
        <h2>© 2020-2021 JGS&nbsp;井冈山大学电子与信息工程学院</h2>
        <h2>版权所有：井冈山大学电子与信息工程学院  地址：江西吉安市青原区学苑路28号  邮编：343009  电话：0796-8100470</h2>
      </div>
      <div class = "about_us footer-content-column">
        <h2>关于我们</h2>
        <ul class = "about_list">
          <li>
            <router-link to = "/product" target = "_blank">学院概况</router-link>
          </li>
        </ul>
      </div>
      ...
      <!-- 版权所有：井冈山大学电子与信息工程学院  地址：江西吉安市青原区学苑路28号  邮编：343009  电话：0796-8100470 -->
