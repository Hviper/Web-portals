...
public class GroupDynamicController {
    ...
    @Autowired
    GroupDynamicService groupDynamicService;
    ...
    public Result<?> SelectByPage(@Param("page") Integer page, @Param("count")Integer count){
        ...
        List<GroupDynamic> groupDynamics = groupDynamicService.SelectByPage(page, count);
        HashMap<Object,Object> map = new HashMap<>();
        map.put("data",groupDynamics);
        map.put("count",groupDynamicService.getMaxCount());
    ...
    public Result<?> SelectByDate(@Param("timerData") String timerData){
        ...
        List<GroupDynamic> news = groupDynamicService.SelectByDate(timerData);
        HashMap<Object,Object> map = new HashMap<>();
        map.put("data",news);
        map.put("count",groupDynamicService.getMaxCount());
        return Result.success(map,"获取新闻成功",200);
